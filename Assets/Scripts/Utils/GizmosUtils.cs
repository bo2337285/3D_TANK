 ...
 public static class GizmosUtils {
     ...
     public static Mesh SemicircleMesh (float radius, float angle, Vector3 axis) {
         Vector3 leftdir = Quaternion.AngleAxis (-angle * 0.5f, axis) * Vector3.forward;
         Vector3 rightdir = Quaternion.AngleAxis (angle * 0.5f, axis) * Vector3.forward;
         int pcount = (int)Mathf.Floor(angle * 0.1f);
         //顶点
